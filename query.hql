-- 1. Numero di tweet: di utenti italiani, nel mese di febbraio 2014, raggruppati per comune
...
-- 2. Analisi dei tweet con i posti effettuando una join per la stessa chiave (dh.id)
...
-- 3. Analizziamo i place che hanno dato un contributo maggiore alla popolarità del tweet
...
-- 4. Analizziamo i tweet in vicinanza di un un posto di tipo bar
SELECT ft.status_id
FROM f_tweet ft
